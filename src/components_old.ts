...
class ComponentNode {
    constructor(
        ...
        private origin: new (...any: any[]) => ComponentNode,
...
type ModifierSpec<T extends Modifier> = [T, number, string, [(new (...any: any[]) => ComponentNode), any[]][]]
...
//is there some way to make them all assignments to function calls?
...
//let thing = new Thing({test: 2}, [Modifier, 0, "test", [Modifier, []] ])
